...
export default function SignerRegister({ ownerName, registerUrl }: Props) {
  return (
    <Html>
      <Head />
      <Preview>Someone you know asked you to be a signer on Until Then</Preview>
      <Body style={s.body}>
        <Container style={s.container}>
          ...
          <Hr style={s.hr} />
          <Text style={s.footer}>Generated automatically by Until Then · set up by wallet {ownerName}.</Text>
        </Container>
      </Body>
    </Html>
  )
